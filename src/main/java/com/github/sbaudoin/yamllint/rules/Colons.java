 ...
 *
 * <ul>
 *   <li>{@code max-spaces-before} defines the maximal number of spaces allowed before colons (use
 *       {@code -1} to disable).
 *   <li>{@code max-spaces-after} defines the maximal number of spaces allowed after colons (use
 *       {@code -1} to disable).
 * </ul>
 *
 * <p>Examples:
 *
 * <p>With <code>colons: {max-spaces-before: 0, max-spaces-after: 1}</code> the following code
 * snippet would **PASS**:
 *
 * <pre>
 *     object:
 ...
 * </pre>
 *
 * <p>With <code>colons: {max-spaces-before: 1}</code> the following code snippet would **PASS**:
 *
 * <pre>
 *     object :
 *       - a
 ...
 * </pre>
 *
 * <p>With <code>brackets: {max-spaces-after: 2}</code> the following code snippet would **PASS**:
 *
 * <pre>
 *     first:  1
 *     second: 2
