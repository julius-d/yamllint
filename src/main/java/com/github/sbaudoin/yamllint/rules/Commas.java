 ...
 *
 * <ul>
 *   <li>{@code max-spaces-before} defines the maximal number of spaces allowed before commas (use
 *       -1 to disable).
 *   <li>{@code min-spaces-after} defines the minimal number of spaces after commas.
 *   <li>{@code max-spaces-after} defines the maximal number of spaces allowed after commas (use -1
 *       to disable).
 * </ul>
 *
 * <p>Examples:
 *
 * <p>With <code>commas: {max-spaces-before: 0}</code> the following code snippet would **PASS**:
 *
 * <pre>
 *     strange var:
 *       [10, 20, 30, {x: 1, y: 2}]
 ...
 * </pre>
 *
 * <p>With <code>commas: {max-spaces-before: 2}</code> the following code snippet would **PASS**:
 *
 * <pre>
 *     strange var:
 *       [10  , 20 , 30,  {x: 1  , y: 2}]
 * </pre>
 *
 * <p>With <code>commas: {max-spaces-before: -1}</code> the following code snippet would **PASS**:
 *
 * <pre>
 *     strange var:
 *       [10,
 ...
 * </pre>
 *
 * <p>With <code>commas: {min-spaces-after: 1, max-spaces-after: 1}</code> the following code
 * snippet would **PASS**:
 *
 * <pre>
 *     strange var:
 ...
 * </pre>
 *
 * <p>With <code>commas: {min-spaces-after: 1, max-spaces-after: 3}</code> the following code
 * snippet would **PASS**:
 *
 * <pre>
 *     strange var:
 ...
 * </pre>
 *
 * <p>With <code>commas: {min-spaces-after: 0, max-spaces-after: 1}</code> the following code
 * snippet would **PASS**:
 *
 * <pre>
 *     strange var:
...
public class Commas extends TokenRule {
  ...
  public List<LintProblem> check(
    ...
    if (token instanceof FlowEntryToken) {
      if (prev != null
          && (int) conf.get(OPTION_MAX_SPACES_BEFORE) != -1
