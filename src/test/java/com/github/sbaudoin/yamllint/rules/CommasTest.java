...
class CommasTest extends RuleTester {
  ...
  @Test
  void beforeMaxWithCommaOnNewLine() throws Exception {
    YamlLintConfig conf =
        getConfig(
            "commas:", "  max-spaces-before: 0", "  min-spaces-after: 0", "  max-spaces-after: -1");
    check(
  ...
  @Test
  void beforeMax3() throws Exception {
    YamlLintConfig conf =
        getConfig(
            "commas:", "  max-spaces-before: 3", "  min-spaces-after: 0", "  max-spaces-after: -1");
    check(
        """
              ---
              array: [1 , 2, 3   , 4]
  ...
  @Test
  void afterMin() throws Exception {
    YamlLintConfig conf =
        getConfig(
            "commas:",
            "  max-spaces-before: -1",
  ...
  @Test
  void afterMax3() throws Exception {
    YamlLintConfig conf =
        getConfig(
            "commas:", "  max-spaces-before: -1", "  min-spaces-after: 1", "  max-spaces-after: 3");
    check(
        """
              ---
              array: [1,  2, 3,   4]
