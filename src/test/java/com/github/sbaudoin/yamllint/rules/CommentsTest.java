...
class CommentsTest extends RuleTester {
  ...
  void disabled() throws Exception {
    YamlLintConfig conf = getConfig("comments: disable", "comments-indentation: disable");
    check(
        """
              ---
              #comment
  ...
  void spacesFromContent() throws Exception {
    YamlLintConfig conf =
        getConfig("comments:", "  require-starting-space: false", "  min-spaces-from-content: 2");
    check(
        """
              ---
              # comment
  ...
  void emptyComment() throws Exception {
    YamlLintConfig conf =
        getConfig("comments:", "  require-starting-space: true", "  min-spaces-from-content: 2");
    check(
        """
              ---
              # This is paragraph 1.
