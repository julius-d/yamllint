...
class SimpleYamlLintConfigTest {
  ...
  void constructorWithNull() throws Exception {
    assertThatThrownBy(() -> new YamlLintConfig((String) null)).isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(() -> new YamlLintConfig((URL) null)).isInstanceOf(IllegalArgumentException.class);
    assertThatThrownBy(() -> new YamlLintConfig((InputStream) null)).isInstanceOf(IllegalArgumentException.class);
  }
  ...
  void invalidConf() {
    ...
    assertThatThrownBy(() -> new YamlLintConfig("not: valid: yaml")).isInstanceOf(YamlLintConfigException.class);

    assertThatThrownBy(() -> new YamlLintConfig("ignore: 3")).isInstanceOf(YamlLintConfigException.class);
  }
  ...
  void unknownRule() {
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: no such rule: \"this-one-does-not-exist\"");
    }
  }
  ...
  void unknownOption() {
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: unknown option \"abcdef\" for rule \"colons\"");
    }
  }
  ...
  void yesNoForBooleans() throws Exception {
    ...
    assertThat(((Map) conf.getRuleConf("indentation")).get("check-multi-line-strings")).isEqualTo(false);
    ...
    conf = new YamlLintConfig("""
                              rules:
                                indentation:
                                  ...
                                  check-multi-line-strings: false
                              """);
    assertThat(((Map) conf.getRuleConf("indentation")).get("indent-sequences")).isEqualTo("whatever");
    assertThat(((Map) conf.getRuleConf("indentation")).get("check-multi-line-strings")).isEqualTo(false);
    ...
    try {
      ...
      assertThat(e.getMessage().startsWith("invalid config: option \"indent-sequences\" of \"indentation\" should be in ")).isTrue();
    }
  }
  ...
  void validateRuleConf() throws Exception {
    ...
    assertThat(YamlLintConfig.validateRuleConf(rule, new HashMap())).isEqualTo(toMap(new Object[][]{{"level", "error"}}));
    assertThat(YamlLintConfig.validateRuleConf(rule, "enable")).isEqualTo(toMap(new Object[][]{{"level", "error"}}));

    try {
      YamlLintConfig.validateRuleConf(rule, "invalid conf");
      fail("Invalid configuration accepted");
    } catch (YamlLintConfigException e) {
      assertThat(e.getMessage()).isEqualTo("invalid config: rule \"dummy-rule\": should be either \"enable\", \"disable\" or a dictionary");
    }
    ...
    Assertions.assertThatCode(() -> {
      ...
      assertThat(rule.ignores(new File("foo"))).isTrue();
      assertThat(rule.ignores(new File("bar"))).isTrue();
    }).withFailMessage("Unexpected error thrown: ").doesNotThrowAnyException();
    ...
    }).withFailMessage("Error level not recognized").doesNotThrowAnyException();
    try {
      YamlLintConfig.validateRuleConf(rule, toMap(new Object[][]{{"level", "warn"}}));
      fail("Unsupported error level accepted");
    } catch (YamlLintConfigException e) {
      assertThat(e.getMessage()).isEqualTo("invalid config: level should be \"error\", \"warning\" or \"info\"");
    }
  }
  ...
  void validateRuleConf2() throws Exception {
    ...
    }).withFailMessage("Supported option value not accepted: ").doesNotThrowAnyException();
    try {
      YamlLintConfig.validateRuleConf(rule, toMap(new Object[][]{{"height", 8}}));
      fail("Unknown option accepted");
    } catch (YamlLintConfigException e) {
      assertThat(e.getMessage()).isEqualTo("invalid config: unknown option \"height\" for rule \"dummy-rule\"");
    }
  }
  ...
  void validateRuleConf3() throws Exception {
    ...
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: option \"a\" of \"dummy-rule\" should be of type boolean");
    }
  }
  ...
  void validateRuleConf4() throws Exception {
    final var rule = getDummyRule(toMap(new Object[][]{{"choice", Arrays.asList(true, 88, "str")}}));
    Assertions.assertThatCode(() -> {
    ...
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: option \"choice\" of \"dummy-rule\" should be in [true, 88, 'str']");
    }
    try {
  ...
  void validateRuleConf5() throws Exception {
    final var rule = getDummyRule(toMap(new Object[][]{{"choice", Arrays.asList(Integer.class, "hardcoded")}}));
    Assertions.assertThatCode(() -> {
    ...
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: option \"choice\" of \"dummy-rule\" should be in [integer, 'hardcoded']");
    }
    try {
      YamlLintConfig.validateRuleConf(rule, toMap(new Object[][]{{"choice", "abc"}}));
      fail("Unsupported option value accepted");
  ...
  void validateRuleConf6() throws Exception {
    ...
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: dummy-rule: the conf says to return an error message");
    }
  }
  ...
  void validateRuleConf7() throws Exception {
    // Test list options
    final var rule = getDummyRule(toMap(new Object[][]{{"alist", Collections.<String>emptyList()}}), true);
    try {
      YamlLintConfig.validateRuleConf(rule, toMap(new Object[][]{{"alist", "not a list"}}));
      fail("Invalid conf accepted");
    } catch (YamlLintConfigException e) {
      assertThat(e.getMessage()).isEqualTo("invalid config: option \"alist\" of \"dummy-rule\" should be a list");
    }
    Assertions.assertThatCode(() -> {
      Map<String, Object> conf = YamlLintConfig.validateRuleConf(rule, toMap(new Object[][]{{"alist", Arrays.asList("value1", "value2")}}));
    }).withFailMessage("Valid list conf failed: ").doesNotThrowAnyException();
  }
  ...
  void mutuallyExclusiveIgnoreKeys() {
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: ignore and ignore-from-file keys cannot be used together");
    }
  }
  ...
  void ignore() throws Exception {
    ...
    assertThatThrownBy(() -> new YamlLintConfig("""
                                                rules:
                                                  indentation:
                                                    spaces: 2
                                                    indent-sequences: true
  ...
  void ignoreFromFileDoesNotExist() {
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: ignore-from-file contains an invalid file path");
    }
  }
  ...
  void ignoreFromFileIncorrectType() {
    try {
      ...
      assertThat(e.getMessage()).isEqualTo("invalid config: ignore-from-file should contain filename(s), either as a list or string");
    }
  ...
  void ignoreFromFileValidConf() {
    ...
    Assertions.assertThatCode(() -> {
      ...
      assertThat(rule.ignores(new File("foo"))).isTrue();
      assertThat(rule.ignores(new File("bar"))).isTrue();
    }).withFailMessage("Unknown error: ").doesNotThrowAnyException();
  }
