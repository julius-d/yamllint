...
class ParserTest {
  ...
  void getTokensOrComments() {
    ...
    assertThat(e.get(1))
        .isEqualTo(new Parser.Comment(1, 1, "# start comment", 0, null, null, null));
    ...
    assertThat(e.get(13))
        .isEqualTo(new Parser.Comment(5, 1, "# a block     ", 0, null, null, null));
    ...
    e = Parser.getTokensOrComments("""
                ...
                # no newline char""");
    assertThat(e.get(2))
        .isEqualTo(new Parser.Comment(2, 1, "# no newline char", 0, null, null, null));
    ...
    e =
        Parser.getTokensOrComments(
            """
                                       ...
                                       """);
    assertThat(e.get(1))
        .isEqualTo(new Parser.Comment(2, 4, "# indented comment", 0, null, null, null));
    ...
    e =
        Parser.getTokensOrComments(
            """
                                       ...
                                       """);
    assertThat(e.get(1))
        .isEqualTo(new Parser.Comment(2, 1, "# trailing spaces    ", 0, null, null, null));
    ...
    e =
        Parser.getTokensOrComments(
                """
                                       ...
                                       """)
            .stream()
            .filter(c -> c instanceof Parser.Comment)
  ...
  void getTokensOrCommentsOrLines() {
    List<Parser.Lined> e =
        Parser.getTokensOrCommentsOrLines(
            """
                                                                 ---
                                                                 k: v  # k=v
                                                                 """);
