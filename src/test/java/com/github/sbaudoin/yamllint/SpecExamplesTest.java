...
class SpecExamplesTest {
  private static final List<String> CONF_GENERAL =
      Arrays.asList(
  ...
  private static final Map<String, List<String>> CONF_OVERRIDES =
      new HashMap<String, List<String>>() {
        {
          ...
          put(
              "example-2.12",
              Arrays.asList("empty-lines: {max-end: 1}\n", "colons: {max-spaces-before: -1}\n"));
          ...
          put(
              "example-7.4",
              Arrays.asList("colons: {max-spaces-before: 1}\n", "indentation: disable\n"));
          ...
          put(
              "example-8.5",
              Arrays.asList("comments-indentation: disable\n", "trailing-spaces: disable\n"));
  ...
  // (using yaml.parse()).
  private static final List<String> SNAKEYAML_BLACKLIST =
      Arrays.asList(
          //            "example-2.11",
          "example-2.23",
          "example-2.24",
  ...
  static Stream<File> getFiles() {
    return Arrays.stream(
            Path.of("src", "test", "resources", "yaml-1.2-spec-examples").toFile().listFiles())
